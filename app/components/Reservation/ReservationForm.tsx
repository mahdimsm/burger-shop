  ...
  return (
    <div className="bg-green-700 p-6 rounded-lg">
      ...
      <div className="mt-[2rem] ">
        ...
        >
          <select
            className="px-10 py-2.5 bg-transparent outline-none font-bold text-[17px]
            text-white border-[2.2px] border-gray-100 rounded-lg"
            name="people"
            id="people"
          >
        ...
        <div className="mt-[2rem] w-[80%] text-center mx-auto ">
            ...
            transition-all duration-700 hover:bg-red-600 text-white">Book Now</button>
        </div>
      </div>
    </div>
  );
