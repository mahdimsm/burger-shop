...
const Reservation = () => {
  return (
    <div className="pt-[5rem]  relative mt-[2rem] pb-[5rem] mb-[3rem] bg-[url('/images/bg-black.jpg')] bg-center bg-cover">
      {/* overlay */}
       <div className="absolute h-full w-full bg-[#000000a6] top-0 right-0 left-0 bottom-0 "></div>
      <div className="w-[80%] relative z-[20] mx-auto grid grid-cols-1 lg:grid-cols-2 items-center gap-[3rem]">
        {/* text-context */}
        <div>
          <h1
            className="text-[30px] md:text-[40px] lg:text-[50px] text-white font-bold leading-[3rem]
            md:leading-[4rem] "
          >
            {" "}
            DO YOU HAVE ANY DINNER PLAN RESERVE TABLE{" "}
          </h1>
          <p className="text-[17px] mt-[1rem] text-white text-opacity-50" >Lorem ipsum dolor sit amet consectetur adipisicing elit. Quam corporis ut repellendus voluptate fuga nobis ullam, iste soluta minus placeat?</p>
