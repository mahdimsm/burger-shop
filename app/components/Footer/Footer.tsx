...
const Footer = () => {
  return (
    <div className="pt-[5rem] pb-[3rem] bg-gray-900">
      <div
        className="w-[80%] pb-[2rem] border-b-[2px] border-b-gray-300 border-opacity-50
      ...
      <p className="text-center text-white opacity-50 mt-[1.5rem]">
        copyright @ 2024 <span className="text-yellow-300">test text</span>. All rights reserved</p>
    </div>
  );
};
